...
const images = {
  logo: "https://media.base44.com/images/public/699871557dfcaafa02868052/8ae82d41d_4x4models.png",
...
const productTags = [
  ["Recovery gear", "recovery-gear", "Winches, recovery boards, straps and trail recovery essentials.", images.tracks, "#d87a3f"],
  ["Overlanding", "overlanding", "Gear for longer 4x4 trips, camp setup and organized touring builds.", images.camp, "#c9a46a"],
  ["Camping setup", "camping-setup", "Shelter, storage and comfort products for nights away from pavement.", images.camp, "#7f9f80"],
  ["Trail lighting", "trail-lighting", "Auxiliary lighting and visibility upgrades for night driving and camp use.", images.light, "#f0c75e"],
  ["Electrical", "electrical", "Dual battery, charging and camp power products for reliable 4x4 builds.", images.battery, "#7ca7d8"],
  ["Tires and traction", "tires-traction", "Traction-focused gear for mud, sand, snow and rough terrain.", images.tire, "#9a8f7a"],
].map(([name, slug, description, image, color]) => ({
  name,
  slug,
  description,
  content: `<p>${description}</p><p>Use this tag page to compare focused 4x4 products by use case, then open product pages for stock, pricing, specs and related buying guides.</p>`,
  meta_description: `${description} Curated for compact, capable 4x4 builds.`,
  focus_keyword: name,
...
const products = [
  {
    ...
    tags: ["Recovery gear", "Tires and traction"],
  },
  {
  ...
  },
  {
    ...
    vendor: "4x4models",
    track_inventory: true,
    tags: ["Overlanding", "Camping setup"],
  },
  {
    ...
    vendor: "4x4models",
    track_inventory: true,
    tags: ["Electrical", "Overlanding"],
  },
  {
    title: "Modular Drawer System",
    slug: "modular-drawer-system",
    excerpt: "Locking rear drawer setup for tools, recovery gear and camp storage.",
    content: "<p>A clean storage base for weekend builds and long-distance touring rigs.</p>",
    category: "Camping",
    ...
    is_product: true,
    featured_image_url: images.workshop,
    featured_image_alt: "Modular 4x4 drawer system",
    product_images: [{ url: images.workshop, alt: "Modular 4x4 drawer system" }],
    vendor: "4x4models",
    track_inventory: true,
    tags: ["Camping setup", "Overlanding"],
  },
  {
    title: "All-Terrain Tire Package",
    slug: "all-terrain-tire-package",
    excerpt: "Balanced all-terrain tire set for daily driving, gravel and trail weekends.",
    content: "<p>A practical tire upgrade for traction without turning every drive into a compromise.</p>",
    category: "Tires",
    product_type: "Tires",
    price: 1049,
    rating: 4.7,
    ...
    status: "published",
    is_product: true,
    featured_image_url: images.tire,
    featured_image_alt: "All terrain tire package",
    product_images: [{ url: images.tire, alt: "All terrain tire package" }],
    vendor: "4x4models",
    track_inventory: true,
    tags: ["Tires and traction"],
  },
  {
    title: "Compact Air Compressor",
    slug: "compact-air-compressor",
    excerpt: "Fast portable compressor for airing up after sand, rocks or muddy trails.",
    content: "<p>A small but essential recovery companion for trips where tire pressure matters.</p>",
    category: "Tires",
    product_type: "Air system",
    price: 219,
    rating: 4.5,
    reviews_count: 58,
    sku: "TIRE-COMP-12V",
    ...
    is_product: true,
    featured_image_url: images.tire,
    featured_image_alt: "Compact 12v air compressor",
    product_images: [{ url: images.tire, alt: "Compact 12v air compressor" }],
    vendor: "4x4models",
    track_inventory: true,
    tags: ["Tires and traction", "Recovery gear"],
  },
  {
    title: "Low-Profile LED Light Bar",
    slug: "low-profile-led-light-bar",
    excerpt: "Slim auxiliary LED bar for trail visibility without visual clutter.",
    content: "<p>Focused lighting for night drives, camp roads and work around the vehicle.</p>",
    category: "Lighting",
    ...
    status: "published",
    is_product: true,
    featured_image_url: images.light,
    featured_image_alt: "Low profile LED light bar",
    product_images: [{ url: images.light, alt: "Low profile LED light bar" }],
    vendor: "4x4models",
    track_inventory: true,
    tags: ["Lighting", "Electrical"],
  },
  {
    title: "Rock Slider Pair",
    slug: "rock-slider-pair",
    excerpt: "Body protection for technical trails, tight ruts and rocky approaches.",
    content: "<p>Protection first: a useful upgrade before cosmetic accessories.</p>",
    category: "Recovery",
    product_type: "Protection",
    price: 679,
    rating: 4.8,
    reviews_count: 33,
    sku: "PROT-SLIDER-PAIR",
    stock: 10,
    status: "published",
    is_product: true,
    featured_image_url: images.tracks,
    featured_image_alt: "Rock slider pair",
    product_images: [{ url: images.tracks, alt: "Rock slider pair" }],
    vendor: "4x4models",
    track_inventory: true,
    tags: ["Recovery gear"],
  },
  {
    title: "Trail Fridge 45L",
    slug: "trail-fridge-45l",
    excerpt: "Efficient 45L fridge for weekends, touring and organized camp kitchens.",
    content: "<p>Keeps food and drinks stable without depending on ice or messy storage.</p>",
    category: "Electrical",
    product_type: "Camp kitchen",
    price: 529,
    rating: 4.7,
    reviews_count: 64,
    sku: "ELEC-FRIDGE-45",
    ...
    is_product: true,
    featured_image_url: images.battery,
    featured_image_alt: "45 liter trail fridge",
    product_images: [{ url: images.battery, alt: "45 liter trail fridge" }],
    vendor: "4x4models",
    track_inventory: true,
    tags: ["Electrical", "Camping setup"],
  },
  {
    title: "270 Degree Awning",
    slug: "270-degree-awning",
    excerpt: "Fast shade coverage for camp, lunch stops and wet-weather field repairs.",
    content: "<p>A quick-deploy awning that makes the vehicle easier to live around.</p>",
    category: "Camping",
    product_type: "Shelter",
    price: 699,
    rating: 4.6,
    ...
    is_product: true,
    featured_image_url: images.camp,
    featured_image_alt: "270 degree awning",
    product_images: [{ url: images.camp, alt: "270 degree awning" }],
    vendor: "4x4models",
    track_inventory: true,
    tags: ["Camping setup", "Overlanding"],
  },
  {
    ...
    slug: "trail-first-aid-roll",
    excerpt: "Compact first-aid roll for vehicle travel, workshops and remote weekends.",
    content: "<p>A sensible safety item that belongs in every practical trail kit.</p>",
    category: "Camping",
    product_type: "Safety",
    price: 89,
    rating: 4.9,
    reviews_count: 22,
    sku: "SAFE-FIRSTAID-ROLL",
    stock: 55,
    status: "published",
    is_product: true,
    featured_image_url: images.camp,
    featured_image_alt: "Trail first aid roll",
    product_images: [{ url: images.camp, alt: "Trail first aid roll" }],
    vendor: "4x4models",
    track_inventory: true,
    tags: ["Camping setup"],
  },
...
async function seed() {
  ...
  for (const tag of productTags) {
    await upsert("ProductTag", { slug: tag.slug }, tag);
  }
